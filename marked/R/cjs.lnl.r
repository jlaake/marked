...
#' result can also be obtained from the functions written wholly in
#' R that are contained in the examples.  The R and FORTRAN code uses the likelihood 
#' formulation of Pledger et al.(2003).
#' 
...
#' ###################################################################################
#' # construct cumphi and cump for known portion of ch from release to last recapture
#' ###################################################################################
...
#' ###################################################################################
#' # first construct a matrix with potential mortality in each column after last occasion seen 
...
#' # next compute the sum over all possible times of death after last occasion seen; 
